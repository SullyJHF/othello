...
B....W..`;
    ...
    expect(within(places[16]!).getByTestId('black')).toBeInTheDocument();
    expect(within(places[21]!).getByTestId('white')).toBeInTheDocument();
    expect(within(places[24]!).getByTestId('black')).toBeInTheDocument();
    expect(within(places[56]!).getByTestId('black')).toBeInTheDocument();
