...
('bullet-1-1', 'Bullet 1+1', 'Fast-paced bullet game with 1 minute + 1 second increment', 'timer', '{"timer": {"type": "increment", "initialTime": 60, "increment": 1, "delay": 0, "maxTime": 180, "lowTimeWarning": 10, "criticalTimeWarning": 5, "timeoutAction": "forfeit", "autoFlagOnTimeout": true, "pauseOnDisconnect": false, "maxPauseTime": 0}, "ui": {"theme": "blitz", "showTimer": true, "showMoveHistory": false, "showEvaluation": false}}', true, false, 2, 2, 5, 'advanced', '{"bullet", "timer", "fast"}'),

('blitz-3-2', 'Blitz 3+2', 'Blitz game with 3 minutes + 2 second increment', 'timer', '{"timer": {"type": "increment", "initialTime": 180, "increment": 2, "delay": 0, "maxTime": 300, "lowTimeWarning": 30, "criticalTimeWarning": 10, "timeoutAction": "auto_pass", "autoFlagOnTimeout": true, "pauseOnDisconnect": true, "maxPauseTime": 60}, "ui": {"theme": "blitz", "showTimer": true, "showMoveHistory": true, "showEvaluation": false}}', true, true, 2, 2, 10, 'intermediate', '{"blitz", "timer", "popular"}'),

('rapid-10-5', 'Rapid 10+5', 'Rapid game with 10 minutes + 5 second increment', 'timer', '{"timer": {"type": "increment", "initialTime": 600, "increment": 5, "delay": 0, "maxTime": 900, "lowTimeWarning": 60, "criticalTimeWarning": 30, "timeoutAction": "auto_pass", "autoFlagOnTimeout": true, "pauseOnDisconnect": true, "maxPauseTime": 300}, "ui": {"theme": "default", "showTimer": true, "showMoveHistory": true, "showEvaluation": true}}', true, false, 2, 2, 20, 'intermediate', '{"rapid", "timer", "standard"}'),

('classical-30-30', 'Classical 30+30', 'Classical game with 30 minutes + 30 second increment', 'timer', '{"timer": {"type": "increment", "initialTime": 1800, "increment": 30, "delay": 0, "maxTime": 3600, "lowTimeWarning": 300, "criticalTimeWarning": 60, "timeoutAction": "auto_pass", "autoFlagOnTimeout": true, "pauseOnDisconnect": true, "maxPauseTime": 600}, "ui": {"theme": "classical", "showTimer": true, "showMoveHistory": true, "showEvaluation": true}}', true, false, 2, 2, 60, 'advanced', '{"classical", "timer", "long"}');
